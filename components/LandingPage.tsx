      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="pt-20 pb-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <SpotifySignInButton className="group px-8 py-4 rounded-2xl bg-[#1DB954] hover:bg-[#1ed760] text-black font-bold text-lg transition-all duration-200 flex items-center gap-3 justify-center glow-purple">
